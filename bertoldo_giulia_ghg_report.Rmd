...
# Process
Data have been cleaned, analyzed, and visualized using R, mainly through the tidyverse package (e.g., dplyr, ggplot). The report has been generated using RMarkdwon. The workflow included working with RStudio, git and GitHub. 
